...
<x-superniftycmsadmin-layout :topic="$topic" :topic_field="$topic_field" :topic_field_type="$topic_field_type">
        ...
        <div id="sn_adminHeader">
            ...
            @if(!is_null($topic))
                <div class="flex justify-between">
                    ...
                    <a class="done" href="{{ route('superniftycms.topics.edit', [ 'id' => $topic->id ]) }}">DONE</a>
                </div>
             @endif
        </div>
    </div>
