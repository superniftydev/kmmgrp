<x-guest-layout :topic=null>{{-- ** Required - Sends $topic variable up to layouts/guest.layout.php blade ** --}}
    ...
    <main id="site-offline">
        <h1>Hi!</h1>
        <p>This site is currently not available.</p>
    </main>
